...
var styles$2 = {"lit":"LitLogo-module_lit__JlGiy","cursorPointer":"LitLogo-module_cursorPointer__vhuFW"};
...
var LitLogo = function LitLogo(_ref) {
  ...
  return /*#__PURE__*/jsxs("div", {
    onClick: onClick,
    className: "".concat(styles$2.lit, " ").concat(_cursorPointer ? styles$2.cursorPointer : ''),
...
var styles$1 = {"label":"InputText-module_label__oLsAY","input":"InputText-module_input__G58vT","purple":"InputText-module_purple__gmq4i"};
...
var css_248z = "@import url(\"https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&display=swap\");.Button-module_reversed__8FWDo .Button-module_btn__daEdK{background:#14042a;border:1px solid #e7ddff;color:#e7ddff}.Button-module_reversed__8FWDo .Button-module_btn__daEdK:hover{background:#14042a;border:1px solid #8159d9;color:#8159d9}.Button-module_btn__daEdK{background:#5f35b8;border-radius:1.5rem;color:#fff;cursor:pointer;display:flex;font-family:Space Grotesk;justify-content:center;min-width:4rem;padding:.5rem 1.5rem;transition-duration:.3s;transition-timing-function:cubic-bezier(.4,0,.2,1);width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}a{color:#fff;text-decoration:none}.Button-module_btn__daEdK:hover{background:#7660a8}";
var styles = {"reversed":"Button-module_reversed__8FWDo","btn":"Button-module_btn__daEdK"};
styleInject(css_248z);

var _excluded = ["label", "type", "onClick", "link", "linkTarget", "reversed"];
var Button = function Button(_ref) {
  ...
  var theme = reversed ? styles.reversed : '';
  return /*#__PURE__*/jsx("div", {
    className: theme,
    children: type == 'callback' ? /*#__PURE__*/jsx("div", {
      onClick: function onClick(e) {
        return _onClick(e);
      },
...
export { Button, InputText, LitLogo };
